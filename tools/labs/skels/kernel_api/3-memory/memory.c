...
static struct task_info *task_info_alloc(int pid)
{
	...
	ti = kmalloc(4096 * sizeof(struct task_info), GFP_KERNEL);
...
static void memory_exit(void)
{
	...
	pr_info("ti1->pid %d, ti1->timestamp: %ld\n", ti1->pid, ti1->timestamp);
	pr_info("ti2->pid %d, ti2->timestamp: %ld\n", ti2->pid, ti2->timestamp);
	pr_info("ti3->pid %d, ti3->timestamp: %ld\n", ti3->pid, ti3->timestamp);
	pr_info("ti4->pid %d, ti4->timestamp: %ld\n", ti4->pid, ti4->timestamp);
